...
class XUIClient:
    ...
    def __init__(self, base_url: str, login: str, password: str, inbound_id: int) -> None:
        ...
        self._login_cache_ttl: float = 0.0
    ...
    async def ensure_logged_in(self) -> None:
        ...
        # Проверяем кэш сессии (действительна 30 минут)
        if self._session_cookie and time.time() < self._login_cache_ttl:
            return
        ...
        self._login_cache_ttl = time.time() + 1800  # 30 минут
