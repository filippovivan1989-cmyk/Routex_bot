...
MY_KEY_MISSING_REMOTE = (
    "Мы не нашли твой ключ в панели RouteX. Возможно, его удалили. Нажми /getkey, чтобы выпустить новый."
)
PANEL_TEMPORARY_ERROR = (
    "Не удалось связаться с панелью RouteX. Попробуй ещё раз немного позже — мы уже разбираемся."
)
DONATE_TEXT = (
