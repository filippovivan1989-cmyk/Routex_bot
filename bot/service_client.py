...
class ServiceClient:
    ...
    async def get_or_create_key(self, tg_user_id: int, inbound_id: int, email: str) -> Dict[str, Any]:
        """Get or create a user key by email."""
        return await self._request(
            "GET",
            "/api/v1/keys/by-user",
            params={"tg_user_id": tg_user_id, "inbound_id": inbound_id, "email": email},
        )
